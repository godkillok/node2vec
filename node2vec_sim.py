...
SENTENCE_EMBEDDING='/data/tanggp/tmp/tags_emb'
tag_dic_path='/data/tanggp/tmp/node_dict'
FASTTEXT_SEARCH='/data/tanggp/tmp/sim/{}/'.format(dt)
...
def read_local():
    ...
    for l in local_path:
        ...
        for i,line in enumerate(lines[1:]):
            ...
            sentence_embedding.append(line.split()[1:])
    ...
    with open("/data/tanggp/tmp/in_node2vec","w",encoding="utf8") as f:
        for i in in_node2vec:
            f.writelines(i+'\n')
